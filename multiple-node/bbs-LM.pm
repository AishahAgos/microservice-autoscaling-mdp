...
const double cpu_request;	//cpu core request by pod
...
module autoscaler
	...
	[scale_in] (0>=u & u<60)  & (pod>maxPod) & (t+TAU<maxTime) -> (current_pod'=desired_replica<minPod?minPod:minPod)&(t'=t+TAU)&(util'=u>util? u_util:util)&(act'=1);
	...
	[scale_out] (lat=-1) & l>0 & (rt>maxRt) & (t+TAU<maxTime)-> 1/2:(current_pod'=desired_replica<maxPod?pod+pod:maxPod)&(lat'=l>0?l-1:lat)&(rt'=up_rt)&(util'=u>util? u_util:util)&(t'=t+TAU)&(act'=0)
