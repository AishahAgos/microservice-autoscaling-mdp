...
module autoscaler
	...
	[scale_out] (lat=-1) & l>0 & (act!=1) & (rt>maxRt) & (t+TAU<maxTime)-> 1/2:(current_pod'=desired_replica<maxPod?pod+pod:maxPod)&(lat'=l>0?l-1:lat)
		&(rt'=up_rt)&(util'=u>util? u_util:util)&(t'=t+TAU)&(act'=0)
		+1/2:(current_pod'=desired_replica<40?pod+4:pod+pod)&(lat'=l>0?l-1:lat)&(rt'=up_rt)&(util'=u>util? u_util:util)&(t'=t+TAU)&(act'=0);
	

	//energy
	[scale_in] (pow>maxPower) & (act!=0) & (pod>maxPod) & (t+TAU<maxTime) -> 
			(current_pod'=desired_replica<minPod?minPod:minPod)&(t'=t+TAU)&(util'=u>util? u_util:util)&(act'=1);
	[scale_in] (power>300) & (act!=0) & (current_pod>maxPod) & (t+TAU<maxTime) -> 
			(current_pod'=desired_replica<minPod?minPod:minPod)&(t'=t+TAU)&(util'=u>util? u_util:util)&(act'=1);
